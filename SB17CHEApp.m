classdef SB17CHEApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            SB17CHEApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'GUI_ACE_Inhib_PKPD')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong GUI_ACE_Inhib_PKPD
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'GUI_ACE_Inhib_PKPD').getString, ...
